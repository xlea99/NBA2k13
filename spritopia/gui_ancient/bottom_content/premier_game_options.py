...
from spritopia.gui_ancient import gui_const
from spritopia.gui_ancient.widgets.player_card_base import PlayerCardBase
from spritopia.gui_ancient.app_state import globalAppState
from spritopia.gui_ancient.widgets.auto_resize_label import AutoResizeLabel
...
class PremierGameOptions(QWidget):
    ...
    def setupPickOptions(self):
        ...
        for i in range(5):
            ...
            thisBallerzPickContainer.setMinimumHeight(40)
        ...
        for i in range(5):
            ...
            thisRingersPickContainer.setMinimumHeight(40)
